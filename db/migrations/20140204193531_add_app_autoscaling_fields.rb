Sequel.migration do
  ...
  up do
    alter_table :apps do
      add_column :min_cpu_threshold, Integer, :default => 0, :null => true
      add_column :max_cpu_threshold, Integer, :default => 0, :null => true
      add_column :min_instances,     Integer, :default => 1, :null => true
      add_column :max_instances,     Integer,                :null => true
    end
  end
  down do
    alter_table :apps do
