    ...
    describe 'Validations' do
      ...
      describe 'name' do
        ...
        it 'should allow standard ascii characters' do
          pending('punctuation not allowed in app names')
          app.name = "A -_- word 2!?()\'\"&+."
          expect {
            app.save
          }.to_not raise_error
        ...
        it 'should allow backslash characters' do
          pending('spaces and backslashes not allowed in app names')
          app.name = 'a \\ word'
          expect {
            app.save
          }.to_not raise_error
        ...
        it 'should allow unicode characters' do
          pending('unicode not allowed in app names')
          app.name = '防御力¡'
          expect {
            app.save
          }.to_not raise_error
    ...
    describe 'creation' do
      ...
      describe 'default enable_ssh' do
        context 'when enable_ssh is set explicitly' do
          it 'does not overwrite it with the default' do
            app1 = App.create_from_hash(name: 'awesomeApp1', space_guid: space.guid, enable_ssh: true)
            expect(app1.enable_ssh).to eq(true)

            app2 = App.create_from_hash(name: 'awesomeApp2', space_guid: space.guid, enable_ssh: false)
      ...
      describe 'default_app_memory' do
        ...
        it 'uses the provided memory' do
          app = App.create_from_hash(name: 'awesomeApp', space_guid: space.guid, memory: 100)
