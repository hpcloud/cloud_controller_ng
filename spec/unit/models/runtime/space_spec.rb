...
module VCAP::CloudController
  describe VCAP::CloudController::Space, type: :model do
    ...
    describe 'Serialization' do
      it { is_expected.to export_attributes :name, :organization_guid, :is_default, :space_quota_definition_guid, :allow_ssh }
      it { is_expected.to import_attributes :name, :organization_guid, :developer_guids, :manager_guids,
        :auditor_guids, :is_default, :security_group_guids, :space_quota_definition_guid, :allow_ssh
      }
    end
    ...
    describe "default space" do
      let(:space) { Space.make() }
        it "not be the default space if not set" do
          expect(space.is_default).to eq(false)
