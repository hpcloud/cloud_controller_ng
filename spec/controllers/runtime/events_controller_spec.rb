  ...
  describe EventsController, type: :controller do
    ...
    describe "pagination" do
      ...
      it "paginates the results" do
        ...
        decoded_response["next_url"].should == "/v2/events?order-by=timestamp&order-direction=asc&page=2&results-per-page=50"
      end
    end
    ...
    describe "pagination + filtering" do
      ...
      it "paginates the results" do
        ...
        decoded_response["total_pages"].should == 2
        decoded_response["prev_url"].should be_nil
        decoded_response["next_url"].should == "/v2/events?order-by=timestamp&order-direction=asc&page=2&q=timestamp%3E=#{start_time.iso8601}%3Btimestamp%3C=#{end_time.iso8601}&results-per-page=50"
      end
    end
